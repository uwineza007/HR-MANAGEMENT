 ...
 *
 */
package hrmanagement.splashScreen;
...
public class SplashForm extends javax.swing.JFrame {
    ...
    public SplashForm() {
        initComponents();
        hrmanagement.DataConnection.ConnectionClass.connection();     
        new Thread()
        {
            @Override
            public void run()
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hrmanagement/splashScreen/SplashGMS.gif"))); // NOI18N
